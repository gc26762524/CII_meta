...
#setwd("~/Desktop/Project/VIH/FMAP/LEFSE/subclass2")
#filename_data<-"all.FMAP.abundance.KeepID.KO.txt"
#filename_meta<-"VIH.mapping.addsubclass.txt"
#Grouplist<-'Kraken_Cyt.CST3'
